...
// Generate writes dashboard.html to dataDir and returns the file path.
func Generate(ctx context.Context, store *db.Store, dataDir string, distFS embed.FS, distRoot string) (string, error) {
