...
INSERT INTO members (id, name, command, claude_md_id, claude_settings_id, git_repo_url, created_at, updated_at)
VALUES (?, ?, ?, ?, ?, ?, ?, ?);
...
UPDATE members SET name = ?, command = ?, claude_md_id = ?, claude_settings_id = ?, git_repo_url = ?, updated_at = ? WHERE id = ?;
