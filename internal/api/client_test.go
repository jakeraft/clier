...
func TestClientErrorPreservesEnvelope(t *testing.T) {
	// The renderer is straight string formatting; the contract worth
	// guarding is structural: Code() pulls the taxonomy slug out of
	// the Problem+JSON body, and Body keeps the raw envelope verbatim
	// for callers that want errors[] / instance / type behind --verbose.
